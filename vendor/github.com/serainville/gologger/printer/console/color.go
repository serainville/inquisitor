...
This file is from "https://github.com/fatih/color".
I did not want to use this file as dependency, instead i use it directly to minimize complexity

Thanx to https://github.com/fatih [Faith] For this library.
